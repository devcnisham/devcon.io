...
export const FEATURE_RULES: Rule[] = [
  ...
  },
  {
    name: "Payments",
    category: "Commerce",
    deps: ["stripe", "@stripe/", "razorpay", "@lemonsqueezy/", "@paddle/", "@polar-sh/", "braintree"],
    envPrefixes: ["STRIPE_", "RAZORPAY_", "PADDLE_", "LEMONSQUEEZY_", "POLAR_"],
  },
  {
    name: "AI",
    category: "Intelligence",
    deps: ["@anthropic-ai/", "openai", "@google/generative-ai", "langchain", "ollama", "groq-sdk", "ai"],
    envPrefixes: ["ANTHROPIC_", "OPENAI_", "GROQ_", "GEMINI_", "GOOGLE_GENERATIVE"],
  },
  {
    name: "Realtime",
    category: "Infrastructure",
    deps: ["socket.io", "socket.io-client", "pusher", "pusher-js", "ably", "partykit", "@supabase/realtime-js"],
    envPrefixes: ["PUSHER_", "ABLY_"],
  },
  {
    name: "Email",
    category: "Communication",
    deps: ["resend", "nodemailer", "@sendgrid/", "postmark", "mailgun.js", "react-email", "@react-email/"],
    envPrefixes: ["RESEND_", "SENDGRID_", "POSTMARK_", "MAILGUN_", "SMTP_", "EMAIL_FROM"],
  },
  {
    name: "File Upload",
    category: "Content",
    deps: ["uploadthing", "@uploadthing/", "multer", "cloudinary", "@aws-sdk/client-s3", "busboy", "formidable"],
    envPrefixes: ["UPLOADTHING_", "CLOUDINARY_", "S3_", "AWS_ACCESS_KEY"],
  },
  {
    name: "Database",
    category: "Infrastructure",
    deps: ["@prisma/client", "prisma", "drizzle-orm", "mongoose", "typeorm", "kysely", "@supabase/supabase-js"],
  ...
  },
  {
    ...
    category: "Infrastructure",
    deps: ["bullmq", "bull", "agenda", "inngest", "@trigger.dev/", "graphile-worker"],
  ...
  },
  {
    name: "Analytics",
    category: "Operations",
    deps: ["posthog-js", "posthog-node", "@vercel/analytics", "mixpanel", "amplitude-js"],
    envPrefixes: ["POSTHOG_", "NEXT_PUBLIC_POSTHOG", "MIXPANEL_"],
  },
  {
    name: "Search",
    category: "Content",
    deps: ["algoliasearch", "meilisearch", "typesense", "@elastic/elasticsearch", "flexsearch"],
